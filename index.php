			...
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<form action="generate.php" method="GET" class="login100-form validate-form flex-sb flex-w">
					...
					<div class="p-t-31 p-b-9">
						<span class="txt1">
							Plz Enter IP Address Or Domain Address Of Your Device
						</span>
				...
				<?php
					...
					?>
						<div class="container-login100-form-btn m-t-17">
						<button class="login100-form-btn" onclick="document.location='JioPlayPlaylist.m3u'">
							Download Playlist m3u File
						</button>
						<div class="container-login100-form-btn m-t-17">
						<button class="login100-form-btn" onclick="document.location='JioPlayPlaylist.php'">
							Download Playlist PHP File
						</button>
					</div>
					<div class="container-login100-form-btn m-t-17">
